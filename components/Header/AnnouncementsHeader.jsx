...
function AnnouncementsHeader() {
  ...
  return (
    <>
      ...
      <div className="text-white py-3 text-[13px] font-bold border-b border-white/10 shadow-2xl pr-4">
        <div className="flex justify-between items-center">
          ...
          >
            <div
              className="flex-1 text-center text-[#fff] transition-all duration-700 ease-in-out tracking-wide cursor-pointer"
              onClick={() => router.push('/announcements')}
            >
