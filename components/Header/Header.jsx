      ...
      <div
        ...
        <div className="flex items-center h-full">
          <div className="flex md:flex items-center gap-4 mr-6 border-r border-slate-700 pr-6 h-5">
            ...
            <a href="https://www.instagram.com/pankajaswani_0109?igsh=MWVwcjBhbGt5ZmFhNw==" className="hover:text-pink-500 transition-colors"><Icons.Instagram /></a>
            <a href="https://www.linkedin.com/in/pankaj52/" className="hover:text-pink-500 transition-colors"><Icons.Linkedin /></a>
          </div>
