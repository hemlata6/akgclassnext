  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        ...
        className="p-2 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-600 hover:text-blue-700 transition-colors"
      ...
      <button
        ...
        className="p-2 rounded-full bg-sky-50 hover:bg-sky-100 text-sky-600 hover:text-sky-700 transition-colors"
      ...
      <button
        ...
        className="p-2 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-700 hover:text-blue-800 transition-colors"
