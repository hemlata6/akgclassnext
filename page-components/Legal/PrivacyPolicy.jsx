                ...
                <div className="max-w-4xl mx-auto py-12">
                    <div className="prose prose-slate max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-slate-700 leading-relaxed mb-4">
                                If you have any questions about this Policy, wish to exercise your rights, concerns about privacy or grievances, please write to us with a thorough description via email to <strong>admin@CA Pankaj Aswani.com</strong>.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-slate-700 leading-relaxed mb-4">
                                For complete details on CCPA data practices, consumer rights, and requests under the CCPA, please refer to the full policy document or contact us at <strong>admin@CA Pankaj Aswani.com</strong>.
                            </p>
                        </section>
                    </div>
                </div>
