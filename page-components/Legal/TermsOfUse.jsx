          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <p className="text-slate-700 leading-relaxed mb-4">
                By signing up on the {institute?.institue ? institute?.institue : "Rishabh Jain"} Website you are agreeing to be bound by the following terms and conditions ("Terms of Use").
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                As the original purchaser of content sold on {institute?.institue ? institute?.institue : "Rishabh Jain"}, you are entitled to access and use the content which is identified in the course and which is on the {institute?.institue ? institute?.institue : "Rishabh Jain"} website, at www.{institute?.institue ? institute?.institue : "Rishabh Jain"}.com ("Website"). In order to access and use this content, you must register with {institute?.institue ? institute?.institue : "Rishabh Jain"} and create a password to use in accessing the content on the Website.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                Your password is unique and exclusive to you, and you may not transfer your password to any other person or allow any other person to use your password to access or use content on the Website. You agree to notify {institute?.institue ? institute?.institue : "Rishabh Jain"} immediately if any other person makes unauthorized use of your password. {institute?.institue ? institute?.institue : "Rishabh Jain"} reserves the right to suspend or revoke your password in the event of any misuse of your password or any use of your password in violation of these Terms and Conditions. In the event of any such suspension or revocation, you will not be entitled to any refund or payment.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                These Terms of Use govern your access to and use of the Website and the content on the Website. By accessing and using the Website, you agree to these Terms of Use. If you do not agree to any of these Terms of Use, you may not access or use the site. {institute?.institue ? institute?.institue : "Rishabh Jain"} reserves the right to modify these Terms of Use at any time and in its sole discretion. Your use of the site following any modification will constitute your assent to and acceptance of the modifications.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                Upon registration, {institute?.institue ? institute?.institue : "Rishabh Jain"} grants you a non-exclusive, non-transferable, non-assignable, personal license to access and use the {institute?.institue ? institute?.institue : "Rishabh Jain"} content identified in the content you purchased via an online/offline reader.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                {institute?.institue ? institute?.institue : "Rishabh Jain"} will not be liable for any delay or interruption in your access to the site or any content located on the site, or for any transmission errors, equipment or software incompatibilities, force majeure or other failure of performance. {institute?.institue ? institute?.institue : "Rishabh Jain"} will use reasonable efforts to correct any failure of performance, but {institute?.institue ? institute?.institue : "Rishabh Jain"} will not be required to make any changes to any equipment or software used by {institute?.institue ? institute?.institue : "Rishabh Jain"} or its contractors or agents to ensure compatibility with any equipment or software used by you. You may not use the site or the content on the site for any commercial purpose, including but not limited to the use of any of the content to market or sell goods or services to any person. You agree not to launch any automated system, including without limitation, "robots," "spiders," or "offline readers," to access the site.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                {institute?.institue ? institute?.institue : "Rishabh Jain"} reserves the right to change, suspend access to, or remove any or all of the content on the Website at any time, for any reason, in its sole discretion. {institute?.institue ? institute?.institue : "Rishabh Jain"} also reserves the right to discontinue the Website at any time, either temporarily or permanently. In the event of the removal of any content from the Website or the termination of the Website, you will not be entitled to any refund or payment.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-6 mb-4">
                ...
                <p className="text-slate-700 leading-relaxed">
                  UNDER NO CIRCUMSTANCES, INCLUDING NEGLIGENCE, SHALL {institute?.institue ? institute?.institue : "Rishabh Jain"} BE HELD LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL OR CONSEQUENTIAL DAMAGES AND EXPENSES OF ANY KIND (INCLUDING, WITHOUT LIMITATION, PERSONAL INJURY OR PROPERTY DAMAGE, LOST PROFITS, AND DAMAGES ARISING FROM COMPUTER VIRUSES, BUSINESS INTERRUPTION, LOST DATA, UNAUTHORIZED ACCESS TO OR USE OF SITE SERVERS OR ANY PERSONAL INFORMATION STORED THEREIN, OR ANY INTERRUPTION OR CESSATION OF OPERATION OF THE SITE) ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE USE OF THE SITE OR ANY INFORMATION CONTAINED ON THE SITE, WHETHER SUCH DAMAGES ARE BASED ON CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
                </p>
              </div>
            </section>
