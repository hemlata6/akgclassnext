          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <p className="text-slate-700 leading-relaxed mb-4">
                By signing up on the ANM Classes Website you are agreeing to be bound by the following terms and conditions ("Terms of Use").
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                As the original purchaser of content sold on ANM Classes, you are entitled to access and use the content which is identified in the course and which is on the ANM Classes website, at www.ANM Classes.com ("Website"). In order to access and use this content, you must register with ANM Classes and create a password to use in accessing the content on the Website.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                Your password is unique and exclusive to you, and you may not transfer your password to any other person or allow any other person to use your password to access or use content on the Website. You agree to notify ANM Classes immediately if any other person makes unauthorized use of your password. ANM Classes reserves the right to suspend or revoke your password in the event of any misuse of your password or any use of your password in violation of these Terms and Conditions. In the event of any such suspension or revocation, you will not be entitled to any refund or payment.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                These Terms of Use govern your access to and use of the Website and the content on the Website. By accessing and using the Website, you agree to these Terms of Use. If you do not agree to any of these Terms of Use, you may not access or use the site. ANM Classes reserves the right to modify these Terms of Use at any time and in its sole discretion. Your use of the site following any modification will constitute your assent to and acceptance of the modifications.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                Upon registration, ANM Classes grants you a non-exclusive, non-transferable, non-assignable, personal license to access and use the ANM Classes content identified in the content you purchased via an online/offline reader.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                ANM Classes will not be liable for any delay or interruption in your access to the site or any content located on the site, or for any transmission errors, equipment or software incompatibilities, force majeure or other failure of performance. ANM Classes will use reasonable efforts to correct any failure of performance, but ANM Classes will not be required to make any changes to any equipment or software used by ANM Classes or its contractors or agents to ensure compatibility with any equipment or software used by you. You may not use the site or the content on the site for any commercial purpose, including but not limited to the use of any of the content to market or sell goods or services to any person. You agree not to launch any automated system, including without limitation, "robots," "spiders," or "offline readers," to access the site.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                ANM Classes reserves the right to change, suspend access to, or remove any or all of the content on the Website at any time, for any reason, in its sole discretion. ANM Classes also reserves the right to discontinue the Website at any time, either temporarily or permanently. In the event of the removal of any content from the Website or the termination of the Website, you will not be entitled to any refund or payment.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                These Terms of Use constitute the entire agreement between you and ANM Classes concerning your use of the Website and the contents of the Website. If any provision is deemed invalid by a court of competent jurisdiction, the remaining provisions shall remain in full force and effect. No waiver of any the Terms of Use shall be deemed a further or continuing waiver of such term or condition or any other term or condition, and any failure by ANM Classes to assert any right or provision under these Terms of Use shall not constitute a waiver of such right or provision.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                <p className="text-slate-700 mb-2"><strong>Email:</strong> admin@ANM Classes.com</p>
