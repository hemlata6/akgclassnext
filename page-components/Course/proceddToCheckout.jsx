...
const ProceedToCheckoutFormTest = ({ cartCourses, setProceedToCheckoutModal }) => {
        ...
        try {
            ...
            if (response?.data?.status === true) {
                ...
                if (urlParams.studentName || urlParams.contact || urlParams.email) {
                    ...
                    router.push(`/store?${queryParams.join('&')}`);
                } else if (!authToken && !isAuthenticated) {
                    router.push('/login', { state: { data: "storeData" } })
                }
...
export default ProceedToCheckoutFormTest;
