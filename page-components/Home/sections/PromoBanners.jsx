                        ...
                        <div className="absolute inset-0 flex items-center justify-start px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24">
                            <div className="w-full max-w-[800px] text-white">
                                ...
                                <div className="font-bebas">
                                    {/* SCORE HIGH WITH */}
                                    <p className="text-white uppercase tracking-[0px] font-bold leading-[0.9] text-[24px] sm:text-[40px]">
                                        SCORE HIGH WITH
                                    </p>
                                    ...
                                    <p className="text-white font-bold leading-[0.9] tracking-[0px] mt-[-4px]">
                                        <span className="font-bebas flex items-center gap-[8px]" style={{ fontSize: 'clamp(28px, 6vw, 40px)' }}>
                                            CA RISHABHH JAINN
                                ...
                                <div className="flex flex-wrap gap-x-0 gap-y-4 mt-[30px] mb-0 font-montserrat w-full">
                                    ...
                                    <div className="flex flex-row items-start gap-3 min-w-[120px] flex-1">
                                        <Award className="text-[#D9A441] w-14 h-14 mt-1 shrink-0" strokeWidth={1.5} />
                                        <div className="flex flex-col items-start">
                                            <span className="text-[#D9A441] text-[32px] font-bold leading-none">1000+</span>
                                            <span className="text-white text-base uppercase font-bold leading-tight mt-1">EXEMPTIONS</span>
                                        </div>
                                    </div>
                                    {/* Stat 2 */}
                                    <div className="flex flex-row items-start gap-3 min-w-[120px] flex-1">
                                        <BadgeCheck className="text-[#D9A441] w-14 h-14 mt-1 shrink-0" strokeWidth={1.5} />
                                        <div className="flex flex-col items-start">
                                            <span className="text-[#D9A441] text-[32px] font-bold leading-none">75+</span>
                                            <span className="text-white text-base uppercase font-bold leading-tight mt-1">ALL INDIA RANKS</span>
                                        </div>
                                    </div>
                                    {/* Stat 3 */}
                                    <div className="flex flex-row items-start gap-3 min-w-[120px] flex-1">
                                        <Medal className="text-[#D9A441] w-14 h-14 mt-1 shrink-0" strokeWidth={1.5} />
                                        <div className="flex flex-col items-start">
                                            <span className="text-[#D9A441] text-[32px] font-bold leading-none">14+</span>
                                            <span className="text-white text-base uppercase font-bold leading-tight mt-1">YEARS OF EXCELLENCE</span>
                                        </div>
                                    </div>
                                    {/* Stat 4 */}
                                    <div className="flex flex-row items-start gap-3 min-w-[120px] flex-1">
                                        <Users className="text-[#D9A441] w-14 h-14 mt-1 shrink-0" strokeWidth={1.5} />
                                        <div className="flex flex-col items-start">
                                            <span className="text-[#D9A441] text-[32px] font-bold leading-none">200K+</span>
                                ...
                                {/* ===== CTA BUTTONS ===== */}
                                <div className="flex flex-wrap items-center gap-4 mt-[20px] font-montserrat">
                                    {/* Primary Button */}
                                    ...
                                    {/* Secondary Button */}
                                    {/* <button className="group/btn relative inline-flex items-center justify-center h-[54px] w-[230px] rounded-lg font-bold text-sm overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-[#D9A441]/15 active:scale-[0.98]"
                                        style={{
                                    ...
                                    >
                                        <span className="mr-3">EXPLORE COURSE</span>
                                        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full border-2 border-white/80">
