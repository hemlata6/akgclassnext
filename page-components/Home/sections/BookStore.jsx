...
export const BookStore = ({ employeeCourseId }) => {
    ...
    const carouselCards = filtered.map((book, idx) => {
        ...
        <section id="books-catalog" className="max-w-7xl mx-auto px-4 sm:px-6 pb-12 pt-12">
            ...
            <div className="mb-8 border-b border-slate-200 pb-5 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div className="space-y-1">
                    <div className="flex items-center gap-3 md:justify-start">
                        <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400">Exclusive Educational Resources</h3>
                    </div>
                    <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900">Books Hub</h2>
                </div>
                ...
                <div className="flex items-center gap-3 flex-wrap md:flex-nowrap">
                    ...
                    {!hasEmployeeCourseSelection && (
                        ...
                        >
                            Explore Books <Icons.ChevronRight size={14} />
                        </button>
                    )}
                </div>
            ...
            {!hasEmployeeCourseSelection && (
                <div className="md:hidden flex justify-center w-full mt-5 mb-2">
                    ...
                    >
                        Explore Books <Icons.ChevronRight size={20} />
                    </button>
                </div>
            )}
