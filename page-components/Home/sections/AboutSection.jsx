        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-4/12 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-lg aspect-[4/4] bg-slate-100">
              <img src="/vghub/Vivek gaba.png" alt="CA Shirish Vyas" className="w-full object-cover" />
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent text-white">
                <p className="font-bold text-lg">CA Shirish Vyas</p>
          ...
          <div className="w-full md:w-8/12 space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed max-w-2xl">
              <strong>At {institute?.institue ? institute?.institue : "CA Shirish Vyas"} , we don’t just teach Accounting & Financial Reporting; we decode it.</strong>, CA Shirish Vyas brings practical industry experience into the classroom, transforming complex accounting concepts and Ind AS into logical, easy-to-retain frameworks. Our goal is simple: to make you <strong>exam-ready and industry-ready</strong>at every stage of the CA journey.
            </p>
