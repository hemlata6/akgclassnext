...
import logo from '../../../public/cawallah/cawallahlogo.png'
            ...
            <div className="mb-4">
              <div className='flex justify-between'>
                <div>
                  <h4 className="text-sm font-bold text-slate-900 mb-1">
                    Free Resources for Smart Preparation
                  </h4>

                  <p className="text-[11px] text-slate-600 mb-3">
                    Access essential study materials to strengthen your preparation:
                  </p>
                </div>
                <div>
                  <span onClick={handleNavigateToResources} className="text-[10px] text-indigo-600 font-bold uppercase cursor-pointer hover:text-indigo-700 transition-colors">View Library</span>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { t: "Mock Tests", i: "📝" },
                  { t: "Strategy PDFs", i: "📊" },
                  { t: "Course Materials", i: "🎓" }
                ].map((r, i) => (
                  <div
                    key={i}
                    onClick={handleNavigateToResources}
                    className="flex items-center gap-2 p-2.5 rounded-lg bg-slate-50 border border-slate-100 hover:border-indigo-200 hover:bg-indigo-50 transition-all cursor-pointer"
                  >
                ...
                {[1, 2].map((i) => (
                  <div key={i} className="flex gap-3 items-center group cursor-pointer p-2 rounded-lg hover:bg-white/10 transition-colors" onClick={handleNavigateToResources}>
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400">CA Wallah • 25k views</p>
                    </div>
                  </div>
                ))}
