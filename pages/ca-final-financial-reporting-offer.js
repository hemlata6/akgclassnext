...
export default function CAFinalFROfferPage() {
    return (
        <>
            <Head>
                <title>CA Final FR Course - Financial Reporting by CA VIVEK GABA | Rahuls CA Academy</title>
            ...
            <div className="min-h-screen bg-[#020617] font-sans text-gray-300 selection:bg-green-500 selection:text-white pb-20 md:pb-0">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 items-center">
                            ...
                            <div className="text-center lg:text-left order-2 lg:order-1">
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-4 md:mb-6 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm">
                                    <span className="text-green-400 font-bold text-xs tracking-widest uppercase">Rahuls CA Academy by Rahuls CA Academy</span>
                ...
                <section className="py-12 md:py-16 bg-[#0f172a]">
                    <div className="max-w-6xl mx-auto px-4">
                        <div className="text-center mb-8 md:mb-12">
                            <h2 className="text-2xl md:text-3xl font-extrabold text-white">Rahuls CA Academy FR Books</h2>
                ...
                <footer className="bg-black text-white pt-12 pb-28 md:pb-10 border-t border-gray-900 relative">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <h2 className="text-xl md:text-2xl font-bold mb-2 tracking-tight">Rahuls CA Academy by Rahuls CA Academy</h2>
                        ...
                        <div className="flex justify-center gap-8 mb-10 items-center">
                            ...
                            <a href="https://youtube.com/@Rahuls CA Academy" target="_blank" rel="noreferrer" className="hover:scale-110 transition-transform">
                        ...
                        <div className="border-t border-gray-900 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-gray-600 tracking-widest uppercase">
                            <p>© 2026 Rahuls CA Academy. All rights reserved.</p>
                    ...
                    <a
                        href="https://wa.me/917703880232?text=Hi%20Rahuls CA Academy%2C%20I%20have%20a%20doubt%20regarding%20CA%20classes."
                        target="_blank"
                        rel="noreferrer"
