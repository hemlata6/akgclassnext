...
export default function Home() {
  ...
  const ogImage = 'https://storage.googleapis.com/stepfly-partners-v1-prod.appspot.com/caclass/adminUploads/Rahuls CA Academy-logo-circle-white.webp';
  ...
  const keywords = 'CA Final, Financial Reporting, Ind AS, CA FR Courses, Rahuls CA Academy, CA Final Preparation, Accounting Standards, FR Video Lectures, CA Study Material';

  const structuredData = {
    "@context": "https://schema.org",
    "@type": "EducationalOrganization",
    "name": "Rahuls CA Academy",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="author" content="Rahuls CA Academy" />
