...
export default function Home() {
  ...
  const keywords = 'CA Final, Financial Reporting, Ind AS, CA FR Courses, CA Wallah, CA Final Preparation, Accounting Standards, FR Video Lectures, CA Study Material';
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="CA Wallah" />
        ...
        <meta name="author" content="CA Wallah" />
