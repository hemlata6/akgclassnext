...
export default function Home() {
  const siteUrl = 'https://lecturedekho.in/';
  const ogImage = 'https://lecturedekho.in/logo.png';
  const title = 'CA Final FR Courses & Materials | AKG Classes - Expert Financial Reporting Coaching';
  const description = 'Best CA Final Financial Reporting courses and materials by industry experts. Comprehensive Ind AS training, video lectures, study materials, and test series for CA Final FR preparation.';
