                ...
                <div className="flex-1 flex items-center justify-center py-20 px-4">
                    <div className="text-center max-w-xl">
                        <div className="mb-8 relative">
                            <div className="w-40 h-40 mx-auto rounded-full flex items-center justify-center relative" style={{backgroundColor: '#0f5be0'}} >
                                <div className="absolute inset-0 rounded-full animate-ping opacity-20" style={{backgroundColor: '#0f5be0'}}></div>
                                <svg className="w-20 h-20 relative z-10" style={{color: '#0f5be0'}} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button
                            ...
                            style={{backgroundColor: '#0f5be0'}}
                            onMouseEnter={(e) => e.target.style.backgroundColor = '#0d3221'}
                            onMouseLeave={(e) => e.target.style.backgroundColor = '#0f5be0'}
                        >
                            <Icons.Back />
                            Back to Home
                        </button>
                ...
                <div className={`py-16 ${LAYOUT_PADDING}`}>
                    ...
                    <div className="text-center mb-12">
                        <button
                            ...
                            onMouseEnter={(e) => e.target.style.color = '#0f5be0'}
                    ...
                    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 space-y-6">
                            <div className="bg-white rounded-2xl p-6 shadow-md border border-slate-200">
                                <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4" style={{backgroundColor: '#0f5be0', color: '#fff'}}>
                                    <Icons.Phone />
                                </div>
                                <h3 className="text-lg font-bold text-slate-900 mb-2">Call Us</h3>
                                <p className="text-slate-600 text-sm mb-2">Mon-Sat from 10am to 7pm</p>
                                <a href="tel:8949190985" className="font-semibold" style={{color: '#0f5be0'}}
                            ...
                            <div className="rounded-2xl p-6 shadow-md text-white" style={{backgroundColor: '#0f5be0'}}>
                        ...
                        <div className="lg:col-span-2">
                            <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-md border border-slate-200 p-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2">
                                            First Name <span style={{color: '#0f5be0'}}>*</span>
                                        </label>
                                        <input
                                            type="text"
                                            name="firstName"
                                            ...
                                            style={{'--tw-ring-color': '#0f5be0'}}
                                            onFocus={(e) => e.target.style.boxShadow = '0 0 0 2px #0f5be0'}
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2">
                                            Last Name <span style={{color: '#0f5be0'}}>*</span>
                                        </label>
                                        <input
                                            type="text"
                                            name="lastName"
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2">
                                            Phone <span style={{color: '#0f5be0'}}>*</span>
                                        </label>
                                        <input
                                            type="tel"
                                            name="phone"
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-slate-700 mb-2">
                                            Email <span style={{color: '#0f5be0'}}>*</span>
                                        </label>
                                        <input
                                            type="email"
                                            name="email"
                                ...
                                <div className="mb-5">
                                    <label className="block text-sm font-semibold text-slate-700 mb-2">
                                        Type <span style={{color: '#0f5be0'}}>*</span>
                                    </label>
                                    <select
                                        name="type"
                                        value={formData.type}
                                ...
                                {formData.type && (
                                    <div className="mb-5 animate-in slide-in-from-top duration-300">
                                        <label className="block text-sm font-semibold text-slate-700 mb-2">
                                            Select {formData.type === 'course' ? 'Course' : 'Test Series'} <span style={{color: '#0f5be0'}}>*</span>
                                        </label>
                                        <select
                                ...
                                <button
                                    ...
                                    style={{backgroundColor: loading ? '#0f5be0' : '#0f5be0'}}
                                    onMouseEnter={(e) => !loading && (e.target.style.backgroundColor = '#0d3221')}
                                    onMouseLeave={(e) => !loading && (e.target.style.backgroundColor = '#0f5be0')}
                                >
                                    {loading ? (
                                        <>
